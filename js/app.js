(() => {
  ...
  const v = {
    ...
    offset: function () {
      if (this.length > 0) {
        ...
        return { top: i.top + o - a, left: i.left + d - r };
      }
      return null;
    },
    css: function (e, t) {
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!a.support.smoothScroll)
            return (
              x({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!a.support.smoothScroll)
            return (
              x({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function G(e) {
    ...
    u && d.target && d.target.shadowRoot && h && (p = b(h[0]));
  ...
  class te {
    constructor(...e) {
      ...
      (i.__swiper__ = !0),
        (i.support = L()),
        (i.device = M({ userAgent: s.userAgent })),
        (i.browser = P()),
        (i.eventsListeners = {}),
    ...
    t({
      ...
      s("click", (t, s) => {
        const { $nextEl: n, $prevEl: a } = e.navigation,
          r = s.target;
        if (e.params.navigation.hideOnClick && !b(r).is(a) && !b(r).is(n)) {
          if (
            e.pagination &&
            e.params.pagination &&
    ...
    function p() {
      ...
      0 !== s.length &&
        (e.params.uniqueNavElements &&
          ...
          ((s = e.$el.find(t.el)),
          s.length > 1 &&
            (s = s.filter((t) => b(t).parents(".swiper")[0] === e.el))),
        ...
        t.clickable &&
          s.on("click", ae(t.bulletClass), function (t) {
            t.preventDefault();
            let s = b(this).index() * e.params.slidesPerGroup;
    ...
    s("init", () => {
      ...
      s("click", (t, s) => {
        ...
        if (
          ...
          a &&
          a.length > 0 &&
          !b(n).hasClass(e.params.pagination.bulletClass)
        ) {
          if (
            e.navigation &&
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".mind__slider") &&
      new se(".mind__slider", {
        modules: [ne, re, oe],
        slidesPerView: 1,
        loop: !0,
      ...
      document.querySelector(".ditta__slider") &&
        new se(".ditta__slider", {
          modules: [ne],
          slidesPerView: 1,
          initialSlide: 1,
          spaceBetween: 90,
  ...
  new de("max").init();
  const ce = document.querySelector(".header__search"),
    pe = document.querySelector(".header__input"),
    ue = document.querySelector(".header__label");
  ce.addEventListener("click", () => {
    ue.classList.add("open"), pe.focus();
  }),
    pe.addEventListener("blur", (e) => {
      ue.classList.remove("open");
    });
  document.querySelector(".video-player");
  document.querySelectorAll(".play-button").forEach((e) => {
    e.addEventListener("click", () => {
      const t = e.closest(".video__item").querySelector(".videos");
      t.paused
        ? (t.play(), e.classList.remove("_icon-play"), (e.textContent = "||"))
        : (t.pause(), e.classList.add("_icon-play"), (e.textContent = ""));
    });
  }),
    (window.FLS = !0),
    (function (e) {
